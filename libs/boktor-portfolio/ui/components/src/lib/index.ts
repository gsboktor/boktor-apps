...
export { ReactComponent as HCALogo } from './assets/hca.svg';
export { ReactComponent as JotaiLogo } from './assets/jotai.svg';
export { ReactComponent as PGLogo } from './assets/pg.svg';
export { ReactComponent as ReactLogo } from './assets/react.svg';
export { ReactComponent as Styled } from './assets/styled.svg';
export { ReactComponent as SupabaseLogo } from './assets/supabase.svg';
export { ReactComponent as TanstackLogo } from './assets/tanstack.svg';
